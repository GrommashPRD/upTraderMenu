    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.CharField(help_text='Может быть абсолютный URL или name для реверса', max_length=200, verbose_name='URL или name URL')),
                ('named_url', models.BooleanField(default=False, verbose_name='URL это name для реверса?')),
